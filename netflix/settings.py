...
from django.conf.global_settings import MEDIA_ROOT, AUTH_USER_MODEL, LOGIN_REDIRECT_URL
...
SECRET_KEY = 'django-insecure-!k=u#gvt^a^i2xvz2^udqgi9ho5g@tjdunf8hmqzkrik5md4*a'
