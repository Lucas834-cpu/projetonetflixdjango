# URL - VIEW - TEMPLATES (coisas que devem ser sempre construidas quando se quer fazer uma pagina no site)
#VIWE (code in python thar will say to you what will happen when a user enter in your page)
#TEMAPLATES (files in HTML)
